...
class RoutesConfiguration {
  ...
  static List<BoatRoute> getMaterialRoutes() => [
    ...
    BoatRoute(
      ...
      builder: (_) => BottomNavigationDemo(restorationId: 'bottom_navigation_demo', type: BottomNavigationDemoType.withLabels),
    ),
    BoatRoute(
      category: RouteCategory.material,
      ...
      builder: (_) => BottomSheetDemo(type: BottomSheetDemoType.modal,),
    ),
    BoatRoute(
      category: RouteCategory.material,
